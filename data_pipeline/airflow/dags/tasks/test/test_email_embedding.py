...
class TestEmailEmbeddingTasks(unittest.TestCase):
    ...
    def test_upload_to_chroma(self):
        ...
        upload_to_chroma.assert_called_once_with(
            user_id, embedded_data_path, mock_client
        )
    ...
    def test_download_processed_from_gcs(self):
        ...
        context = {
            "dag_run": MagicMock(
                conf={"processed_gcs_uri": "gs://bucket_name/object_name"}
            ),
            "ds": "2025-01-01",
            "ti": MagicMock(),
        }
    ...
    def test_upsert_embeddings(self):
        ...
        context = {
            "dag_run": MagicMock(
                conf={
                    "processed_gcs_uri": "gs://bucket_name/processed/data/user123/file.parquet"
                }
            ),
            "ti": MagicMock(
                xcom_pull=MagicMock(return_value="/tmp/path/to/embedded_data")
            ),
        }
